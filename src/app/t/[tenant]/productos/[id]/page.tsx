...
import { EcommerceCartSheet, EcommerceProductDetailView } from "@/features/ecommerce/components/storefront";
import {
...
export default function PublicProductDetailPage() {
  ...
  const [storefront, setStorefront] = useState<PublicEcommerceStorefront | null>(
    null,
  );
      ...
      <div className="mx-auto flex min-h-screen max-w-3xl items-center justify-center px-4 text-center">
        <div>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            El producto solicitado no existe, ya no esta activo o la tienda no es publica.
          </p>
        </div>
      </div>
    );
